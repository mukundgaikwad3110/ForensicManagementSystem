...
<center><h2 style="color: white;">Update NCR Form </h2></center>
            ...
            <div class="signup-content">
               <!--  <div class="signup-img" style="width: 500px;">
                ...
                <div class="signup-form">
                    <form method="POST" class="register-form" id="register-form"  style="   padding-left: 100px;" action="UpdateNCRProcess.jsp?ncr_id=<%= ncr_id %>">
                        <!-- style="width:1117px;" -->
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group" style="width: 300px;">
                            ...
                            <input type="date" name="date" id="date" style="width: 200px;" value="<%=rs.getString(3)%>" readonly>
                        </div>

                        <div class="form-group" style="margin-left: 180px;width: 300px;">
                            <label for="ncrno">NCR No. :</label>
                            <input type="text" name="ncrno" id="ncrno" style="width: 200px;"  onkeypress="isInputNumber(event)" value="<%=rs.getString(4)%>" readonly/>
                        </div>
                      ...
                      <div class="form-row">
                            <div class="form-group" style="width: 300px;">
                                ...
                                <input type="date" name="date1" id="date1" style="width: 216px;" readonly value="<%=rs.getString(8)%>" /><br>

                            </div><br>
                            <div class="form-group" style="width: 300px; margin-left: 160px;">
                                <label for="time">Time :</label>
                                <input type="Time" name="time" id="time" style="width: 216px;" readonly value="<%=rs.getString(9)%>"/><br>
                ...
                <div id="javaquery" ></div> 
                        ...
                        <div class="form-submit" style="margin-bottom: 46px;">
                            <input type="reset" value="Cancel" class="submit" name="reset" id="reset" onclick="window.location='NCRTableOfficer.jsp'" />
                            <input type="submit" value="Update" class="submit" name="submit" id="submit" style="margin-right: -53px;"/>
                        </div>
                        <% }
