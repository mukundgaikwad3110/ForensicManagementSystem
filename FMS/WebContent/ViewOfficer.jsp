        ...
        <div class="container">
            <div class="signup-content">
                ...
                <div class="signup-form">
                    <form method="POST" class="register-form" id="register-form" style="padding-left: 100px;"  action="#" enctype="multipart/form-data" name="pgenerate">
                     <!--  -->
                        
                        
                        <div class="form-row">
                            <div class="form-group">
                            <input type="hidden" name="emp_id" id="reg_id" value=<%=request.getParameter("emp_id")%> >
...
">
                          <div >
                        <img src="getOfficerImage.jsp?id=<%=emp_id%>" width="200px" style="margin-top: 26px;height: 220px;
"> 
                          </div>     
...
"  readonly />
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group"  >
                                <label style="margin-left: 14px;" >Password :</label>
                                 <input class="form-control" type="password" id="password" name="output" value="<%=rs.getString(10)%>_<%=rs.getString(12)%>" style="margin-left: 13px;" readonly>
                        ...
                        <div class="form-submit">
                            ...
                            <input type="button"  class="submit" value="Back"  id="submit" onClick="javascript:window.location='OfficerTable.jsp?';" />
