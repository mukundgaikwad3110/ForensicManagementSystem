...
if(!conn.isClosed()){
	...
	out.println("<html><body><script>alert('Your FIR Report is registered Successfully!!!'); window.location = 'FIRTableOfficer.jsp';</script><body><html>");
	conn.close();
	conn.close();
}
