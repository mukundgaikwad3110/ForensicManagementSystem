          ...
          <div class="col-lg-12">
            <section class="panel">
              <header class="panel-heading">
               <h1><center>Lawyer Table</center></h1>
              </header>
<br>
 <center>
...
String sql ="select * from lawyerdetails ";
...
%>
<tr>
<td><%=resultSet.getString("lawyer_id") %></td>
...
<td><%=resultSet.getString("address") %></td>
 ...
 <td>
      <div class="btn-group">
       <a href="ViewLawyer.jsp?lawyer_id=<%=resultSet.getInt(1)%> "button class="btn btn-warning" target="">View</button></i></a>
      </div>
 </td>
