          ...
          <div class="col-lg-12">
            <section class="panel">
              <header class="panel-heading">
               <h1><center>Suspects NCR Table</center></h1>
              </header>
<br>
 <center>
...
String sql ="select * from suspectsncr where emp_id="+emp_id;
...
<td><%=resultSet.getString("mobno") %></td>
 <td>
      <div class="btn-group">
       <a href="ViewSuspectsNCR.jsp?id=<%=resultSet.getInt(1)%> " button class="btn btn-info" target="">View</button></i></a>
      </div>
 </td>
