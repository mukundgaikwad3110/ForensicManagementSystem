...
String query="select * from ncr where ncr_id=" +id; 
        ...
        <div class="container" style="width: 1148px;">
            <div class="signup-content"  >
                ...
                <div class="signup-form">
                    <form method="POST" class="register-form" id="register-form" style="padding-left: 100px;" action="SuspectsNCR" enctype="multipart/form-data">
                        <!-- style="width:1117px;" -->
                        <div class="form-row">
 					<input type="hidden" name="emp_id" id="emp_id" style="width: 200px;" value="<%=rs.getString(1)%>">
                        ...
                        <div class="form-group" style="width: 300px;">
                            ...
                            <input type="text" name="ncrno" id="ncrno" style="width: 200px;"  value="<%=rs.getString(4)%>" onkeypress="isInputNumber(event)" />
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" name="firstname" id="f_name" style="width: 216px;"required/><br>


                                 <label for="middlename">Middle Name :</label>
                                <input type="text" name="middlename" id="m_name" style="width: 216px;"required/><br>

                                <label for="lastname">Last Name :</label>
                                <input type="text" name="lastname" id="l_name" style="width: 216px;" required/><br>
                            </div>
