...
%> 
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo">Crime Investigation<span class="lite">&nbspDepartment</span></a>
      <!--logo end-->
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
              ...
              <li class="eborder-top">
                <a href="AdminPannel.jsp"><i class="icon_profile"></i> My Profile</a>
              </li>
              <li>
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          <li class="active">
            <a class="" href="useractivitestable.html" target="container1">
...
<i class='fas fa-folder-open'></i>
              ...
              <ul class="sub">
                <li><a class="" href="FIRTable.jsp" target="container1"><i class='fas fa-paste'></i><span>FIR</span></a></li>
                <li><a class="" href="NCRTable.jsp" target="container1"><i class='fas fa-paste'></i><span>NCR</span></a></li>
              </ul>
            </li>
            <li>
            <a class="" href="#">
  ...
  <iframe class="embed-responsive-item" name="container1" src="(unknown)" style="width:100%;height:630px;"></iframe>
</div>
