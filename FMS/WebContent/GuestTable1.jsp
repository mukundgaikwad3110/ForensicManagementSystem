          ...
          <div class="col-lg-12">
            <section class="panel">
              <header class="panel-heading">
               <h1><center>Guest Table</center></h1>
              </header>
<br>
 <center>
...
String sql ="select * from permanent_emp where designation='Guest' and department='Laboratory'";
...
<td><a class="btn btn-warning btn-sm" href="" title="Bootstrap 3 themes generator">Suspend</a>
      <a class="btn btn-danger btn-sm" href="" title="Bootstrap 3 themes generator">Dismiss</a>
 </td>
