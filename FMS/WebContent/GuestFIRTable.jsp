          ...
          <div class="col-lg-12">
            <section class="panel">
              <header class="panel-heading">
               <h1><center>Guest FIR Table</center></h1>
              </header>
<br>
 <center>
...
String sql ="select * from guest_fir where guest="+emp_id;
...
<td><%=resultSet.getString("age") %></td>
 <td>
                      <div class="btn-group">
                       <a href="ViewGuestFIR.jsp?id=<%=resultSet.getInt(3)%> "button class="btn btn-success" target="">View</button></i></a>
                      </div>
                    </td>
