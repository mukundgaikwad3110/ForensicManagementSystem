...
String query = "insert into guest_ncr(emp_id,date,ncrno,policestation,acts,section,date1,time,nameofcomplainant,nameofwitness,complaint,guest)values('"+emp_id+"','"+date+"','"+ncrno+"','"+policestation+"','"+acts+"','"+section+"','"+date1+"','"+time+"','"+nameofcomplainant+"','"+nameofwitness+"','"+complaint+"','"+guest_id+"')";
...
if(!conn.isClosed()){
	...
	out.println("<html><body><script>alert('Your Guest is Added Successfully!!!'); window.location = 'NCRTableOfficer.jsp';</script><body><html>");
	conn.close();
}
