...
String query="select * from suspectsncr where id=" +id; 
            ...
            <div class="signup-content"  >
                ...
                <div class="signup-form">
                    <form method="POST" class="register-form" id="register-form" style="padding-left: 100px;" action="CriminalFIR" enctype="multipart/form-data">
 					...
 					<%-- <input type="hidden" name="emp_id" id="emp_id" style="width: 200px;" value="<%=rs.getString(1)%>"> --%>
                        ...
                        <div class="form-group" style="width: 300px;">
                            ...
                            <input type="text" name="ncrno" id="ncrno" style="width: 200px;"  value="<%=rs.getString(2)%>" onkeypress="isInputNumber(event)" />
                        </div>
                   ...
                   <div class="form-group" style="padding-left: 50px;	">
                          <div >
                           <img src="GetSuspectsNCRImage.jsp?id=<%=rs.getString(1)%>" id="blah" width="100" height="100">
                          </div>     
