...
String Countrow1,Countrow2,Countrow3=null;
%>
 ...
 <!-- container section start -->
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo">Forensic<span class="lite">Management</span></a>
      <!--logo end-->
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a class="" href="#">Officers</a></li>
              <li><a class="" href="#">Supervisors</a></li>
               <li><a class="" href="#">Guests</a></li>
...
String sql ="SELECT  COUNT(*) FROM permanent_emp GROUP BY designation ";
resultSet = statement.executeQuery(sql);

/* String sql1 ="SELECT designation, COUNT(*) FROM permanent_emp GROUP BY designation Having designation='Supervisor'";
...
Countrow3 = resultSet.getString(1); 
