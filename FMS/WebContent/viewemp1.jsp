...
">
                          <div >
                        <img src="getImage.jsp?id=<%=reg_id%>" width="200px" style="margin-top: 26px;height: 220px;
"> 
                          </div>     
...
"  readonly />
                        ...
                        <div class="form-submit">
                            ...
                            <input type="button"  class="submit" value="Reject"  onClick="javascript:window.location='reject.jsp?reg_id=<%=request.getParameter("reg_id")%>';" />
