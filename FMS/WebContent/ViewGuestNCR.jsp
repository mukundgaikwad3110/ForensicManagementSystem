...
<center><h2 style="color: white;">Non-Cogninzible Report </h2></center>
        ...
        <div class="container">
            <div class="signup-content">
                ...
                <div class="signup-form">
                    <form method="POST" class="register-form" id="register-form"  style="   padding-left: 100px;" action="#">
                   <div class="form-row">
