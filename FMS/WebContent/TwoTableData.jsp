...
String database = "forensic?allowMultiQueries=true";
String userid = "root";
String password = "";
try {
          ...
          <div class="col-lg-12">
            <section class="panel">
              <header class="panel-heading">
               <h1><center>Non-Cognizible Report</center></h1>
              </header>
<br>
 <center>
              ...
              <table class="table table-striped table-advance table-hover">
                <tbody>
                 ...
                 <th><i class="icon_cogs"></i>Guests</th> 
...
connection = DriverManager.getConnection(connectionUrl+database, userid, password);
statement=connection.createStatement();
String sql ="select * from ncr where ncr_id=4";
