          ...
          <div class="col-lg-12">
            <section class="panel">
              <header class="panel-heading">
               <h1><center>Evidence NCR Table</center></h1>
              </header>
<br>
 <center>
...
String sql ="select * from evidencencr where emp_id="+emp_id;
...
<td>
      <div class="btn-group">
       <a href="ViewEvidenceNCR.jsp?id=<%=resultSet.getInt(1)%> "button class="btn btn-success" target="">View</button></i></a>
      </div>
 </td>
...
%>
    ...
    <div class="text-right">
      <div class="credits">
          ...
          -->
          Designed by <a href="https://cravitaindia.com/" target="">Cravita Technologies</a>
        </div>
    </div>
  </section>
