            ...
            <div class="signup-content">
               <!--  <div class="signup-img" style="width: 500px;">
                ...
                <div class="signup-form">
                    <form method="POST" class="register-form" id="register-form" style="padding-left: 100px;" action="EvidenceNCR" enctype="multipart/form-data">
                        <!-- style="width:1117px;" -->
 					...
 					<input type="hidden" name="emp_id" id="emp_id" style="width: 200px;" value="<%=rs.getString(1)%>">
                        ...
                        <div class="form-group" style="width: 300px;">
                            ...
                            <input type="date" name="date" id="date" style="width: 200px;"  onkeypress="isInputNumber(event)" value="<%=rs.getString(8)%>"/>
                        </div>
