...
/*  String emp_id=request.getParameter("reg_id");
...
if(rs.next()){
    ...
    <center><h2 style="color: white;">My Profile</h2></center>
...
">
                          <div >
                        <img src="getIconImage.jsp?id=<%=emp_id%>" width="200px" style="margin-top: 26px;height: 220px;
"> 
                          </div>     
...
"  readonly />
                            ...
                            <div class="form-group" >
                                ...
                                <input type="text" name="txtPANCard" id="txtPANCard" value="<%=rs.getString(19)%>" readonly/>
                        ...
                        <div class="form-submit">
                          ...
                          <!--  <input type="button"  class="submit" value="Back"  id="submit" onClick="javascript:window.location='BackToPageForAdmin.jsp?';" /> -->
