...
String sql ="SELECT * from permanent_emp JOIN guest_ncr ON permanent_emp.emp_id=guest_ncr.guest where ncrno="+ncrno;
...
<td><%=resultSet.getString("email") %></td>  
  <td>
      <div class="btn-group">
       <a href="SuspendGuestNCR.jsp?id=<%=resultSet.getString("guest_id")%> "button class="btn btn-danger btn-sm" target="">Suspend</button></i></a>
      </div>
 </td> 
