...
String query="select * from evidencefir where firno=" +firno; 
...
<center><h2 style="color: white;">View Evidence Form </h2></center>
                ...
                <div class="signup-form">
					 ...
					 <div class="form-row">
                        ...
                        <div class="form-group" style="width: 300px;">
                         ...
                         <div class="form-select" style="width: 200px;">
                           ...
                           <input type="text" name="evidenceType" id="evidenceType"  value="<%=rs.getString(4)%>" readonly/>
					...
					<div class="form-row">
						<div class="form-group" style="width: 300px;">
                           ...
                           <img src="GetImageEvidenceFIR.jsp?firno=<%=firno%>" width="100px" height="100px">
                          </div> 
  ...
  Your browser does not support the video tag.
         ...
         <!-- <div class="form-submit" style="margin-bottom: 46px;">
                            <input type="reset" value="Cancel" class="submit" name="reset" id="reset" onclick="window.location='EvidenceFIRTable.jsp'" />
