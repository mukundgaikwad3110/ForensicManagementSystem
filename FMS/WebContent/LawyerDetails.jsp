...
<body>
    <center><h2 style="color: white;">Lawyer Registration Form</h2></center>
                    ...
                    <form method="POST" class="register-form" id="register-form" style="padding-left: 100px;" action="LawyerRegistration" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" name="firstname" id="firstname" style="width: 216px;"required/><br>


                                 <label for="m_name">Middle Name :</label>
                                <input type="text" name="middlename" id="middlename" style="width: 216px;"required/><br>

                                <label for="l_name">Last Name :</label>
                                <input type="text" name="lastname" id="lastname" style="width: 216px;" required/><br>
                            </div>
...
">
                     ...
                     <div class="form-group" style="width: 300px;">
                            ...
                            <input type="date" name="dob" id="dob" style="width: 200px;" onchange="agefinding();">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="form-group" style="width: 300px;">
                                ...
                                <div class="form-select" style="width: 200px;">
                                    <select onchange="myFunction(this)" name="lawyertype" >
                                        <option value="select">Select LawyerType</option>
                            ...
                            <div class="form-row" style="padding-left: 15px;">
	                            <div class="form-group"  style="width: 238px;">
	                                ...
	                                <input type="date" name="lbrd" id="lbrd" style="width: 216px;"/>
	                            </div>  
