        ...
        <div class="container" style="width: 1148px;">
            <div class="signup-content"  >
                ...
                <div class="signup-form">
                    <form method="POST" class="register-form" id="register-form" style="padding-left: 100px;" action="Suspects" enctype="multipart/form-data">
                        <!-- style="width:1117px;" -->
                        <div class="form-row">
 					<input type="hidden" name="emp_id" id="emp_id" style="width: 200px;" value="<%=rs.getString(1)%>">
                        ...
                        <div class="form-group" style="width: 300px;">
                            ...
                            <input type="text" name="firno" id="firno" style="width: 200px;"  value="<%=rs.getString(9)%>" onkeypress="isInputNumber(event)" value="<%=rs.getString(13)%>"/>
                        </div>
