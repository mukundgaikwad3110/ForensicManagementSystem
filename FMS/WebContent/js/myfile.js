    ...
    $(document).ready(function(){
        ...
        country_arr[0]="Select State";
        country_arr[1]="MAHARASHTRA";
        country_arr[2]="TAMILNADU";
        country_arr[3]="GOA";
        country_arr[4]="W-BENGAL";
        country_arr[5]="GUJARAT";
        country_arr[6]="MADHYAPRADESH";
        country_arr[7]="RAJASTHAN";
