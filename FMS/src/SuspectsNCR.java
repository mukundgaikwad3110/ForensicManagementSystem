...
/**
 * Servlet implementation class SuspectsNCR
 */
@WebServlet("/SuspectsNCR")
@MultipartConfig(maxFileSize = 16177216)
public class SuspectsNCR extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(part != null){
			try{
			    ...
			    ps = con.prepareStatement("insert into suspectsNCR(ncrno,firstname,middlename,lastname,image,address,gender,mobno,emp_id)values(?,?,?,?,?,?,?,?,?)");
			    InputStream is = part.getInputStream();
			    ps.setBlob(5, is);
			    
			    String firno=request.getParameter("ncrno");
		        ...
		        if(!con.isClosed())
		        {
		        	...
		        	printWriter.print("<html><body><script>alert('Suspects Registered Successfully!!!'); window.location = 'SuspectsNCRTable.jsp';</script><body><html>");
